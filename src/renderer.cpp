...
renderer::operator SDL_Renderer *() noexcept { return _renderer.get(); }

void renderer::begin() noexcept { SDL_RenderClear(*this); }

void renderer::end() noexcept { SDL_RenderPresent(*this); }
